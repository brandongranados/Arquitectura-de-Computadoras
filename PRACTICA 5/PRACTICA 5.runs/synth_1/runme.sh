...
HD_PWD='/home/brandon/Documentos/PRACTICA 5/PRACTICA 5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p5bt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p5bt.tcl
