...
HD_PWD='/home/brandon/Documentos/PRACTICA 5/PRACTICA 5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p5bt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p5bt.tcl -notrace
