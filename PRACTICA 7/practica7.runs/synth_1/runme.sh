...
HD_PWD='/home/brandon/Documentos/practica7/practica7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p7.tcl
