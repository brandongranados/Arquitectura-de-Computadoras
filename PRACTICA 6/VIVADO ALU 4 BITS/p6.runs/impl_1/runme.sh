...
HD_PWD='/home/brandon/Documentos/p6/p6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu4bits.tcl -notrace
