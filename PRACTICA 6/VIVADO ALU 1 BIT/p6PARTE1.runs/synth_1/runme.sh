...
HD_PWD='/home/brandon/Documentos/p6PARTE1/p6PARTE1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu1.tcl
