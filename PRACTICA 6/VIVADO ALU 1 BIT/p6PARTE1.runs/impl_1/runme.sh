...
HD_PWD='/home/brandon/Documentos/p6PARTE1/p6PARTE1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu1.tcl -notrace
