...
HD_PWD='/home/brandon/Documentos/p13/p13.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_UnidadControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_UnidadControl.tcl
