...
HD_PWD='/home/brandon/Documentos/p11contador/p11contador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p12.tcl
