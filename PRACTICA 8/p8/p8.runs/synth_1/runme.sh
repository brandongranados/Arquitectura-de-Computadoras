...
HD_PWD='/home/brandon/Documentos/p8/p8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memProg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memProg.tcl
