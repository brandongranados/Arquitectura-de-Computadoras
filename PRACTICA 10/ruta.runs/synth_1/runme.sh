...
HD_PWD='/home/brandon/Documentos/ruta/ruta.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log escom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source escom.tcl
